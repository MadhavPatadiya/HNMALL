                                        ...
                                        <div class="col-3 "id="photo">
                                            ...
                                            <?php if($dikari->member_image): ?>
                                                <img src="<?php echo e(asset('uploads/dikari/member_image/' . $dikari->member_image)); ?>"
                                                    class="img-fit" id="g1" />
                                            <?php else: ?>
                                                <img src="<?php echo e(asset('assets/white.png')); ?>" class="img-fit" id="g1">
                                            <?php endif; ?>
                                    ...
                                    <div class="row lab-s mt-5">
                                        <div class="col-4">
                                            <label style="width: 100%" id="w2"><b class="fonts"> સભ્યપદ નં.</b> <input
                                                    ...
                                                    value="<?php echo e($dikari->member_no); ?>">
                                            </label>
                                        </div>
                                        <div class="col-4">
                                            <center>
                                    ...
                                    <div class="row lab-s mt-2">
                                        <div class="col-8">
                                            <label style="width: 100%"><b class="fonts">દિકરીનું નામ :</b> <input
                                                    ...
                                                    value="<?php echo e($dikari->daughter_name); ?>"></label>
                                        </div>
                                        <div class="col-4">
                                            <label style="width: 100%"><b class="fonts">સભ્ય સાથેના સબંધ :</b> <input
                                                    class="dis-relationship_with_member_2" readonly type="text"
                                                    value="<?php echo e($dikari->relationship_with_member_2); ?>"></label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-5">
                                            <label style="width: 100%">
                                                <b class="fonts">દિકરીની જન્મ તા.:</b> <input class="dis-birth_date_of_daughter" readonly
                                                    type="text"
                                                    value="<?php echo e(date('d-m-Y', strtotime($dikari->birth_date_of_daughter))); ?>">
                                            </label>
                                        </div>
                                        <div class="col-3">
                                            <label style="width: 100%"> <b class="fonts">દિકરીની ઉંમર: </b><input class="dis-age_2"
                                                    readonly type="text" value="<?php echo e($dikari->age_2); ?>">
                                            </label>
                                        </div>
                                                ...
                                                <center>
                                                    ...
                                                    <label style="width: 100%"> <b class="fonts">દિકરીની
                                                            ...
                                                            <img class="dis-daughter_sign_image" readonly
                                                                src="<?php echo e(asset('uploads/dikari/daughter_sign_image/' . $dikari->daughter_sign_image)); ?>"
                                        ...
                                        <div class="row lab-s">
                                            <div class="col-12">
                                                <label style="width: 100%"> <b class="fonts">૧૮ વર્ષ પૂર્ણ થતાં મળવાપાત્ર રકમ : <input class="amount_get"
                                                    readonly type="text" value="<?php echo e($dikari->kariyavar_amount); ?>"></b>
                                                </label>
                                            </div>
                                    ...
                                    <div class="row d">
                                        ...
                                        <div class="col-4 b-right"><label id="w2"><b class="fonts">સભ્યની સહી.</b></label><br>
                                            <?php if($dikari->member_sign_image): ?>
                                                <img class="dis-daughter_sign_image2"
                                                    src="<?php echo e(asset('uploads/dikari/member_sign_image/' . $dikari->member_sign_image)); ?>"
                                                    width="150px" class="sign2" />
                                            <?php else: ?>
                                                <p>&nbsp;</p>
                                            <?php endif; ?>
                                        ...
                                        <div class="col-4 b-right"><label id="w2"><b class="fonts">વારસદારની સહી</b> </label><br>
                                            <?php if($dikari->heir_sign_image_1): ?>
                                                <img class="dis-daughter_sign_image2"
                                                    src="<?php echo e(asset('uploads/dikari/heir_sign_image_1/' . $dikari->heir_sign_image_1)); ?>"
                                                    width="150px" class="sign2" />
                                            <?php else: ?>
                                                <p>&nbsp;</p>
                                            <?php endif; ?>
                                        ...
                                        <div class="col-4 sahi"><label id="w2"><b class="fonts">એચ.એન.મોલ વતી</b></label><br>
                                            <label style="font-size:21px;margin: -20px;font-weight:700;" for=""><?php echo e($user->where('id', '=', $dikari->login_id)->first()->name); ?></label><br>

                                            <?php if($dikari->sign_on_behalf_of_jan_jagaruti_image): ?>
                                                <img class="dis-daughter_sign_image2"
                                                    src="<?php echo e(asset('uploads/dikari/sign_on_behalf_of_jan_jagaruti_image/' . $dikari->sign_on_behalf_of_jan_jagaruti_image)); ?>"
                                                    width="150px" class="sign2" />
                                            <?php else: ?>
                                                <p >&nbsp;</p>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/dikari/view.blade.php ENDPATH**/ ?>