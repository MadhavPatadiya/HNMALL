                            ...
                            <div class="">
                                <div class="">
                                    <div class="container">
                                        ...
                                        <center>
                                            <h4 class="h4 mt-2">ફિક્સ ડિપોઝિટ - રદ કરવાની પહોંચ</h4>
                                        </center>
                                            ...
                                            <div class="row">
                                                <div class="row photo justify-content">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <label style="width: 100%" id="w3"><b
                                                                        class="fonts">સભ્યપદ નં.
                                                                        :</b> <input class="dis-no" readonly type="text"
                                                                        value="{{ $deposite->member_no }}">
                                                                </label>
                                                                <label class="mt-3" style="width: 100%" id="w3"><b
                                                                        class="fonts">કુલ ભરેલી રકમ: રૂ</b>
                                                            ...
                                                            <div class="col-6">
                                                                <label style="width: 100%" id="w3"><b
                                                                        class="fonts">યોજનાનો પ્રકાર
                                                                        :</b> <input class="dis-yojanano_prakar" readonly
                                                                        type="text" value="રદ ફાઇલ">
                                                                </label>
                                                                <label class="mt-3" style="width: 100%" id="w3"><b
                                                                        class="fonts">તારીખ :
                                                            ...
                                                            <div class="col-12">
                                                                <label style="width: 100%" id="w3"><b
                                                                        class="fonts">રકમ શબ્દોમાં
                                                                        :</b>
                                                                    <input class="dis-words" readonly type="text"
                                                                        value="{{ $deposite->words }}">
                                                                </label>
                                                            </div>
                                                            <center class="mt-5" id="w3" style="font-size:30px">
                                                                <b class="fonts2">(&nbsp;સભ્યની &nbsp; વિગત
                                                                    &nbsp;)</b>
                                                            </center>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 mt-2">
                                                <label style="width: 100%"><b class="fonts">સભ્યનું નામ :</b> <input
                                        ...
                                        <div class="row">
                                            <div class="col-8 mt-2">
                                                <label style="width: 100%"><b class="fonts">સરનામું:</b> <input
                                                        class="dis-address" readonly type="text"
                                                        value="{{ $deposite->address }}">
                                                </label>
                                            </div>
                                            <div class="col-4 mt-2">
                                                <label style="width: 100%"><b class="fonts">જિલ્લા: </b><input
                                        ...
                                        <div class="row">
                                            <div class="col-6 mt-2">
                                                <label style="width: 100%"><b class="fonts">મોં (1) : </b><input
                                                        class="dis-mobile_1" readonly type="text"
                                                        value="{{ $deposite->mobile_no_1 }}">
                                                </label>
                                            </div>
                                            <div class="col-6 mt-2">
                                                <label style="width: 100%"><b class="fonts">(2) :</b><input
                                                        class="dis-mobile_2" readonly type="text"
                                                        value="{{ $deposite->mobile_no_1 }}">
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row A">
                                            ...
                                            <div class="col-6"><label style="width: 100%"><b class="fonts">પરત કરવાની
                                                        રકમ:</b><input type="text" readonly class="dis-refund_amount"
                                                        value="{{ $refund->first()->refund_amount }}"></label>
                                            </div>
                                            <div class="col-6"><label style="width: 100%"><b class="fonts">જામીનનું
                                                        નામ</b>:<input type="text" readonly class="dis-jaamin_nam"
                                                        value="{{ $refund->first()->jaamin_nam }}"></label>
                                            </div>
                                        </div>
                                        {{-- <div class="row">
                                            <div class="col-6"><label id="w2"> <b>નાણા આપનારની સહી :</b></label>
                                                <input type="text" class="dis-sn" readonly>
                                            </div>
                                            <div class="col-6"><label id="w2"><b>નાણા સ્વીકારનારની
                                                        સહી:</b></label>
                                        ...
                                        <div class="row b">
                                            <div class="col-4 sahi"><label class="l1" id="w2"> <b
                                                        class="fonts">સભ્યની
                                                        સહી</b></label>
                                            </div>
                                            <div class="col-4 sahi"><label class="l1" id="w2"><b
                                                        class="fonts">સાક્ષીની
                                                        સહી</b></label>
                                            </div>
                                            <div class="col-4 sahi"><label class="l1" id="w2"> <b
                                                        class="fonts">એચ.એન.મોલ
                                                        વતી</b></label>
                                            </div>
                                        </div>
                                    </div>
