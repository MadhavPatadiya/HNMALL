                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="myForm" action="<?php echo e(url('admin/deposite/save')); ?>" method="POST"
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <input class="form1 form-control" id="validationCustom01" type="number"
                                            value="000<?php echo e(optional($lastDeposite->last())->member_no + 0001 ?? ''); ?>"
                                        ...
                                        <input style="display: none" class="form1 form-control" id="validationCustom01"
                                            type="number"
                                            value="0<?php echo e(optional($lastDepositeReceiptNo->last())->receipt_no + 1 ?? ''); ?>"
                                    ...
                                    <datalist id="Name1">
                                        <?php $__currentLoopData = $lastDeposite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lastDeposites): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option><?php echo e($lastDeposites->mr); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </datalist>
                                    <div class="col-md-4">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/deposite/index.blade.php ENDPATH**/ ?>