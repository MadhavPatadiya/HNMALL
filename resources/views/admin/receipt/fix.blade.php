                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped " id="example1">
                                ...
                                <tbody>
                                    @foreach (Session::get('deposite') as $deposites)
                                        <tr>
                                            <td width="2%">{{ $deposites->id }}</td>
                                            <td width="10%">{{ $deposites->receipt_no }}</td>
                                            <td width="10%">{{ date('d-m-Y', strtotime($deposites->member_date)) }}</td>
                                            <td width="10%">
                                                {{ $user->where('id', '=', $deposites->login_id)->first()->name }}</td>
                                            <td width="20%">{{ $deposites->mr }}</td>
