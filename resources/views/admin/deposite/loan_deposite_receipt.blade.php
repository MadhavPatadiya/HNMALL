                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @forelse ($loanPayment as $loanPayments)
                                        <tr>
                                            <td>{{ $loanPayments->id }}</td>
                                            <td>{{ $user->where('id','=',$loanPayments->login_id)->first()->name }}</td>
                                            <td>{{ date('d-m-Y', strtotime($loanPayments->date)) }}</td>
                                            <td>{{ $loanPayments->amount }}</td>
                                            <td><a href="{{ url('admin/deposite/' . $loanPayments->id . '/view_loan_deposite') }}"
