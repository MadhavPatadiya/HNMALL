...
@section('content')
    ...
    <body>
        <div class="page-body">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-6">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a href="{{ url('admin/emi/emi_receipt') }}">EMI લોન
                                        પહોંચ
                                    </a>
                                </li>

                                <li class="breadcrumb-item active"> <a
                                        href="{{ url('admin/emi/' . $EMILoan->id . '/emi_all_receipt') }}">EMI જમા
                                        પહોંચ
                                        યાદી
                                    </a>
                                </li>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            <div class="col-9 mt-2 mb-2">
                                                <label style="width: 100%"> <b class="fonts">શ્રી,</b><input type="text"
                                                        class="dis2-mr" readonly value="{{ $EMILoan->mr }}"></label>
                                            </div>
                                            <div class="col-3 mt-2 mb-2"><label style="width: 100%"><b class="fonts"> ગામ :
                                                    </b><input id="row-1" type="text" class="dis2-village" readonly
                                                        value="{{ $EMILoan->village }}"></label></div>
                                        </div>
                                        <div class="row custom-line">
                                            <div class="col-9 mt-2 mb-2">
                                                <label style="width: 100%"><b class="fonts">સરનામુ: </b><input
                                                        type="text" class="dis2-address" readonly
                                                        value="{{ $EMILoan->address }}"></label>
                                            </div>

                                            <div class="col-3 mt-2 mb-2"><label style="width: 100%"> <b
                                                        class="fonts">તાલુકો :</b> <input id="row-1" type="text"
                                                        class="dis2-taluk" readonly value="{{ $EMILoan->taluk }}"></label>
                                            </div>
                                        </div>
                                        <div class="col-9 mt-2 mb-2">
                                            <label style="width: 120%"><b class="fonts">નૉૅધ :</b><input
                                                    type="text" class="dis2-address" readonly
                                                    value="{{ $EMIreceipt->note }}"></label>
                                        </div>

                                        {{-- <div class="col-6"
                                                style="{{ $EMILoan->product_name === null ? 'display: none;' : '' }}">
                                                <label style="width: 100%"> Product Name :<input id="row-1"
                                                        type="text" class="dis2-product_name" readonly
                                                        value="{{ $EMILoan->product_name }}">
                                                </label>
                                            </div> --}}
                                        {{-- <div class="col-6">
                                                <label style="width: 100%"> કિંમત : <input id="row-1" type="text"
                                                        class="dis2-price" readonly value="{{ $EMILoan->price }}">
                                                </label>
                                            </div> --}}
                                        {{-- <div class="col-6"
                                                style="{{ $EMILoan->down_payment === null ? 'display: none;' : '' }}">
                                                ડાઉન પેમેન્ટ : <input class="dis2-down_payment" id="row-1"
                                                    type="text" readonly value="{{ $EMILoan->down_payment }}">
                                            </div> --}}

                                        {{-- <div class="col-4 mt-2">
                                                <label style="width: 100%"> વ્યાજ : <input id="row-1" type="text"
                                                        class="dis2-Interest_amount" readonly
                                                ...
                                                <div class="mb-2">
                                                    <label style="width: 100%"> <b class="fonts">કુલ ચૂકવેલ :</b>
                                                        <input id="row-1" type="text" class="dis2-total_paid"
                                                            readonly value="{{ $EMIreceipt->remaining_loan_amount }}">
                                                    </label>
                                                </div>
                                                {{-- <div>
                                                    <label style="width: 100%"> <b class="fonts">બાકીની કુલ લોનની રકમ
                                                        ...
                                                        <input id="row-1" type="text"
                                                            ...
                                                            value="{{ $EMIWallet->first()->total_amount }}">
                                                    </label>
                                                </div> --}}
                                            ...
                                            <div class="col-5" id="col-1">
                                                <div class="mt-2">
                                                    <label style="width: 100%"><b class="fonts"> લોનની રકમ :</b> <input
                                                            ...
                                                            readonly value="{{ $EMILoan->loan_amount }}">
                                                    </label>
                                                </div>
                                        ...
                                        <div class="row sahi custom-line">
                                            <div class="col-3 mt-5"><label style="width: 100%" id="w3"><b
                                                    ...
                                                    {{-- <input type="text" class="dis2-sign1" readonly> --}}
                                            </div>
                                            <div class="col-3 mt-5"><label style="width: 100%" id="w3"><b
                                                        class="fonts">નાણા
                                                        સ્વીકારનારની સહી
            ...
            <input value="{{$user->where('id', '=', $EMIreceipt->login_id)->first()->name }}" type="text" class="dis2-sign2" readonly>
                                            </div>
