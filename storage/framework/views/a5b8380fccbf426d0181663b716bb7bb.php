                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="dateForm" action="<?php echo e(url('admin/real_roj_med/view_real_roj_med')); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <div class="row abc">
                            ...
                            <div class="mt-5">
                                ...
                                <table class="table table-bordered table-striped" id="example11">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><b>માસિક બચત આવક : <?php echo e($deposite_totals); ?></b> </td>
                                            <td><b>માસિક બચત જાવક : <?php echo e($masik_javak); ?></b></td>
                                        </tr>
                                        <tr>
                                            <td><b>ફિક્સ ડિપોઝીટ આવક : <?php echo e($fix_deposit_total); ?> </b></td>
                                            <td><b>ફિક્સ ડિપોઝીટ જાવક : <?php echo e($deposit_javak); ?></b></td>
                                        </tr>
                                        <tr>
                                            <td><b>દીકરી કરિયાવર આવક : <?php echo e($dikari_form_amount); ?> </b></td>
                                            <td><b>દીકરી કરિયાવર જાવક : <?php echo e($dikari_total); ?></b></td>
                                        </tr>
                                        <tr>
                                            <td><b>Emi લોન આવક : <?php echo e($total2); ?> </b></td>
                                            <td><b>Emi લોન જાવક : <?php echo e($loan_emi_form_amount); ?></b></td>
                                        </tr>
                                        <tr>
                                            <td><b>ઓફિસ આવક : <?php echo e($RojMed_amount); ?> </b></td>
                                            <td><b>ઓફિસ જાવક : <?php echo e($RojMed_amount2); ?></b></td>
                                        </tr>
                                        <tr>
                                            <td><b>કુલ જોડાવાની ફી : <?php echo e($joining_fees); ?></b></td>
                                            
                                        </tr>
                                        <tr>
                                            <td style="text-align: center;"><b>કુલ આવક : <?php echo e($aavak_total); ?></b></td>
                                            <td style="text-align: center;"><b>કુલ જાવક : <?php echo e($javak_total); ?></b></td>
                                        </tr>

                                        <tr>
                                            <td colspan="2" style="text-align: center; background-color:grey">
                                                <b>ગ્રાન્ડ ટોટલ : <?php echo e($grand_total); ?></b>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/roj_med/view_real_roj_med.blade.php ENDPATH**/ ?>