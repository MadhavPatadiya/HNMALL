                        ...
                        <div class="col-6">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a
                                        href="{{ url('admin/bachat-receipt/deactive_list') }}">માસિક બચત રદ કરો
                                    </a>
                                </li>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row AA">
                                            ...
                                            <div class="col-4"><label style="width: 100%" id="w2"><b
                                                        ...
                                                        value="{{ $bachats->member_date }}"></label>
                                            </div>
                                            <div class="col-4"><label style="width: 100%" id="w2"><b
                                                        class="fonts">તારીખ:</b><input type="date" readonly
                                                        class="dis-refund_date"
                                                        value="{{ $masikdeactive->first()->deactivate_date }}"></label>
                                            </div>
                                            <div class="col-9">
                                            ...
                                            <div class="col-3">
                                                <label> <b class="fonts">ગામ :</b><input type="text" readonly
                                                        class="dis-village" value="{{ $bachats->village }}">
                                                </label>
                                            </div>
                                            <div class="col-9">
                                        ...
                                        <div class="row sahi custom-line">
                                            ...
                                            <div class="col-5 mt-2"><label id="w2"> <b>એચ.એન.મોલ વતી:</b></label>
                                                <input style="font-size: 18px;" value="{{$user->where('id', '=', $bachats->login_id)->first()->name }}" type="text" class="dis-sn" readonly>
                                            </div>
