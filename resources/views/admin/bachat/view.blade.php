                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-6">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a href="{{ url('admin/bachat/create') }}">માસિક બચત
                                        ફોર્મ
                                    </a>
                                </li>
                                ...
                                <div class="">
                                    <div class="container">
                                                    ...
                                                    <div class="col-10">
                                                        <label class="l-1" style="width: 100%">
                                                            ...
                                                            <input class="dis-member_no" readonly type="text"
                                                                value="{{ $bachat->member_no }}">
                                                        </label>
                                                        <p>

                                                            {{-- <div class="i1">{{$bachat->member_no}}</div> --}}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12"><label class="l-1" style="width: 100%">
                                                            ...
                                                            <input class="dis-member_date" readonly type="text"
                                                                value="{{ date('d/m/Y', strtotime($bachat->member_date)) }}">
                                                        </label><br>
                                                    </div>
                                                    {{-- {{ $bachat->member_date }} --}}
                                                </div>
                                        ...
                                        <div class="row A mt-2">
                                            ...
                                            {{-- <div class="col-4">
                                                <label style="width: 100%"><b class="fonts">સભ્ય સાથેના સબંધ
                                                        :</b>
                                        ...
                                        <div class="row mt-2">
                                            <div class="col-12">
                                                {{-- <label>->ફિક્સ ૧૨-માસ માટે વળતર ૧.૨૫% લેખે આપવામાં આવશે.
                                        ...
                                        <div class="col-12">
                                            <label>->ફિક્સ ૧૨-માસ માટે વળતર ૧.૨૫% લેખે આપવામાં આવશે.
                                                <input type="checkbox" disabled
                                                    {{ $bachat->percentage_1_25 == '1' ? 'checked' : 'unchecked' }}>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row b">
                                        <div class="col-12">
                                            <label>-> અધવચ્ચે ગમે ત્યારે ઉપાડે તો ૧% લેખે વળતર આપવામાં આવશે.
                                                <input type="checkbox" disabled
                                                    {{ $bachat->percentage_1 == '1' ? 'checked' : 'unchecked' }}>
                                            </label>
                                        </div>
                                    </div> --}}
                                        ...
                                        {{-- <div class="row b">
                                            <div class="col-12">
                                                <h6 style="font-size: 20px; padding-top:5px;" class="d">
                                                    મેં આ ગ્રુપ ના બધા જ નિયમો વાંચ્યા છે તેમજ તેને સમજી
                                                    વિચારીને હું <br> મારી મરજીથી તેમાં જોડાવું છું તે બદલ હું નીચે સહી કરી
                                                    આપું
                                                    છું.
                                                </h6>
                                            </div>
                                            ...
                                            <label class="border-t">
                                                ...
                                                <center style="margin-top: -19px;">
                                                    ...
                                                    @else
                                                        <p>&nbsp;</p>
                                                    @endif
                                                    <label style="font-size: 25px;margin: -20px;font-weight:700;" for="">{{$user->where('id', '=', $bachat->login_id)->first()->name }}</label><br>
