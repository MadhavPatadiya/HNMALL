    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7"><img class="bg-img-cover bg-center"
                    src="{{ asset('admin/assets/images/login/2.jpg') }}" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card">
                    <div>
                        <div class="logo text-start">
                            <img class="img-fluid for-light" src="{{ asset('admin/assets/images/login_logo_HN-removebg.png') }}"
                                alt="looginpage" width="300">
                            <img class="img-fluid for-dark" src="{{ asset('admin/assets/images/login_logo_HN-removebg.png') }}"
                                alt="looginpage">
