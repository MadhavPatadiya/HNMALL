                                ...
                                <div class="container">
                                    ...
                                    <div class="row " id="heading">
                                        <div class="col-3 mb-1" id="i1">
                                            ...
                                            <img src="<?php echo e(asset('admin/assets/images/image.jpg')); ?>" height="120px"
                                                width="90px">
                                        </div>

                                        <div class="col-6 mt-4">
                                            <img src="<?php echo e(asset('admin/assets/images/h_n_mall_2.jpg')); ?>" width="80%">
                                        ...
                                        <div class="col-3 mt-4" id="i2"> <img
                                                src="<?php echo e(asset('admin/assets/images/HN.jpg')); ?>" height="90px"
                                                width=""></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-2">
                                            ...
                                            <div class="row">
                                                <div class="col-12"><label class="l-1" style="width: 100%">
                                                        ...
                                                        <input class="dis-member_date" readonly type="text"
                                                            value="<?php echo e(date('d/m/Y', strtotime($EMILoan->member_date))); ?>">
                                                    </label><br>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-7">
                                            ...
                                            <label style="width: 100%"><b style="font-size: 20px">લોનની રકમ : </b> <input
                                                    ...
                                                    value="<?php echo e($EMILoan->loan_amount); ?>" id="total_amount">
                                            </label>
                                            <label style="width: 100%"><b style="font-size: 20px">લોનની રકમ : </b> <input
                                    ...
                                    <div class="row mb-2">
                                        <div class="col-6 mt-2"
                                            ...
                                            <label style="width: 100%"><b class="fonts">Product Name :</b>
                                                <input class="dis-product_name" readonly type="text"
                                                    value="<?php echo e($EMILoan->product_name); ?>">
                                            </label>
                                        </div>
                                        <div class="col-6 mt-2">
                                        ...
                                        <div class="col-6 mt-2">
                                            <label style="width: 100%"><b class="fonts">લોનની રકમ :
                                                    ...
                                                    value="<?php echo e($EMILoan->loan_amount); ?>">
                                            </label>
                                        </div>
                                    ...
                                    <div class="row bbb custom-line">
                                        ...
                                        <div class="col-4" style="margin-top: -18px;
                                            ...
                                            <?php else: ?>
                                                <p>&nbsp;</p>
                                            <?php endif; ?>
                                            <label style="font-size: 18px;margin:-20px;font-weight:700;" for=""><?php echo e($user->where('id', '=', $EMILoan->login_id)->first()->name); ?></label><br>
                                            <label class="border-t" id="w3">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/emi/view.blade.php ENDPATH**/ ?>