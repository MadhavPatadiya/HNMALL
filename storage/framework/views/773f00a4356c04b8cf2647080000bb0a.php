                ...
                <div class="row mt-5">
                    ...
                    <div class="col-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">રિફંડ એકાઉન્ટ સૂચિ
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="col-12">
                                <h5 class="ani">રિફંડ એકાઉન્ટ સૂચિ
                                </h5>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $deposite; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deposites): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(url('admin/deposite/' . $deposites->id . '/view_receipt')); ?>"
                                                ...
                                                <a href="<?php echo e(url('admin/deposite/' . $deposites->id . '/view_completed')); ?>"
                                                    class="btn btn-primary"> રિફંડ પહોંચ</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/deposite/completed_list.blade.php ENDPATH**/ ?>