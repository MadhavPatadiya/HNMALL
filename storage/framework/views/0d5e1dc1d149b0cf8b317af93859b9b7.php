                        ...
                        <div class="col-6">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> <a
                                        href="<?php echo e(url('admin/deposite/fix_deposite_receipt')); ?>">ફિક્સ
                                        ડિપોઝિટ પહોંચ

                                    </a>
                                </li>
                                <li class="breadcrumb-item active"> <a
                                        href="<?php echo e(url('admin/deposite/completed_list')); ?>">રિફંડ
                                        એકાઉન્ટ સૂચિ
                                                            ...
                                                            <div class="col-6">
                                                                ...
                                                                <label class="mt-3" style="width: 100%"
                                                                    id="w3"><b class="fonts">તારીખ :
                                                                        ...
                                                                        value="<?php echo e(date('d/m/Y', strtotime($deposite->maturity_period))); ?>">
                                                                </label>
                                                            </div>
                                                            <div class="col-12">
                                                                <label style="width: 100%" id="w3"><b class="fonts">રકમ શબ્દોમાં
                                                                    ...
                                                                    <input class="dis-words" readonly type="text"
                                                                        value="<?php echo e($deposite->words); ?>">
                                                                </label>
                                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8 mt-2">
                                                <label style="width: 100%"><b class="fonts">સભ્યનું નામ :</b> <input class="dis-mr"
                                                        readonly type="text" value="<?php echo e($deposite->mr); ?>">
                                                </label>
                                            </div>
                                            <div class="col-4 mt-2">
                                                <label style="width: 100%"><b class="fonts">ગામ :</b><input class="dis-village" readonly
                                                        type="text" value="<?php echo e($deposite->village); ?>">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-8 mt-2">
                                                <label style="width: 100%"><b class="fonts">સરનામું:</b> <input class="dis-address"
                                                        readonly type="text" value="<?php echo e($deposite->address); ?>">
                                                </label>
                                            </div>
                                            <div class="col-4 mt-2">
                                                <label style="width: 100%"><b class="fonts">જિલ્લા: </b><input class="dis-city" readonly
                                                        type="text" value="<?php echo e($deposite->city); ?>">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-6 mt-2">
                                                <label style="width: 100%"><b class="fonts">મોં (1) : </b><input class="dis-mobile_1"
                                                        readonly type="text" value="<?php echo e($deposite->mobile_no_1); ?>">
                                                </label>
                                            </div>
                                            <div class="col-6 mt-2">
                                        ...
                                        <div class="row">
                                            <div class="col-8 mt-2">
                                                <label style="width: 100%"><b class="fonts">વારસદારનું નામ :</b> <input
                                                        ...
                                                        value="<?php echo e($deposite->heir_name_1); ?>">
                                                </label>
                                            </div>
                                            <div class="col-4 mt-2">
                                                <label style="width: 100%"><b class="fonts">ઉંમર :</b><input class="dis-age" readonly
                                                        type="text" value="<?php echo e($deposite->age_1); ?>">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row A">
                                        ...
                                        <div class="row">
                                            <div class="col mt-3">
                                                <label style="width: 100%"><b class="fonts">આ યોજનામાં તા.</b> <input
                                                        ...
                                                        value="<?php echo e(date('d/m/Y', strtotime($deposite->member_date))); ?>">
                                                    <b class="fonts"> રૂ.</b>
                                                    <input class="dis-total_amount_2" readonly type="text"
                                                        value="<?php echo e($deposite->total_amount); ?>"><b class="fonts">(અંકે રૂ.<input
                                                            class="dis-words_2" readonly type="text"
                                                            value="<?php echo e($deposite->words); ?>">)</b>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mt-2">
                                                <label style="width: 100%"><b class="fonts">ગ્રુપમાં ભરપાઈ કરેલ હતા તે આજ રોજની તા.</b>
                                                    <input class="dis-maturity_period_2" readonly type="text"
                                                        value="<?php echo e(date('d/m/Y', strtotime($deposite->maturity_period))); ?>"><b class="fonts">રોજ
                                                        વળતર સહિત</b>
                                                </label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col mt-2">
                                                <label style="width: 100%"><b class="fonts">રૂ. </b><input class="dis-vyaj_amount"
                                                        readonly type="text"
                                                        value="<?php echo e($deposite->vyaj_amount); ?>"><b class="fonts">(અંકે રૂ.
                                                        <input class="dis-vyaj_amount_words" readonly type="text"
                                                            value="<?php echo e($deposite->vyaj_amount_words); ?>">)પરત આપવામાં આવેલ
                                                        છે.</b>
                                                </label>
                                            </div>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/deposite/view_completed.blade.php ENDPATH**/ ?>