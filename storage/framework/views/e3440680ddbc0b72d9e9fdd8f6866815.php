                            ...
                            <div class="row m-0 chart-main">
                                <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6 masik">
                                    <div class="media align-items-center">
                                        <a href="<?php echo e(url('/admin/bachat-receipt/create')); ?>">
                                            <div class="media-body">
                                                <div class="right-chart-content">
                                                    <h4><?php echo e($bachats_form->count()); ?>
                                ...
                                <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                                    <div class="media align-items-center">
                                        <a href="<?php echo e(url('/admin/deposite/fix_deposite_receipt')); ?>">
                                            <div class="media-body">
                                                <div class="right-chart-content">
                                                    <h4><?php echo e($deposite_form->count()); ?></h4><span> ફિક્સ
                                                        ડિપોઝિટ</span>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                                    <div class="media align-items-center">
                                        <a href="<?php echo e(url('admin/dikari/receipt')); ?>">
                                            <div class="media-body">
                                                <div class="right-chart-content">
                                                    <h4><?php echo e($dikari_form->count()); ?></h4><span> દીકરીના
                                                        કરિયાવર</span>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div class="col-xl-3 col-md-6 col-sm-6 p-0 box-col-6">
                                    <div class="media border-none align-items-center">
                                        <a href="<?php echo e(url('/admin/emi/emi_receipt')); ?>">
                                            <div class="media-body">
                                                <div class="right-chart-content">
                                                    <h4><?php echo e($loan_emi_form->count()); ?></h4><span>લોન</span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body right-chart-content">
                                    ...
                                    <input type="text" style="display: none" id="bachat" value="<?php echo e($total_bachat); ?>">
                                ...
                                <div class="knob-block text-center">
                                    ...
                                    <input class="knob1" data-width="10" data-height="70" data-thickness=".3"
                                        ...
                                        data-bgcolor="#eef5fb" value="<?php echo e(round($totalP)); ?>"%>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                <div class="media-body right-chart-content">
                                    ...
                                    <input type="text" style="display: none" id="deposite" value="<?php echo e($total_amount); ?>">
                            ...
                            <div class="media align-items-center">
                                <div class="media-body right-chart-content">
                                    ...
                                    <input type="text" style="display: none" id="dikari"
                                        value="<?php echo e($total_kariyavar); ?>">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="knob-block text-center">
                                    ...
                                    <input class="knob1" data-width="10" data-height="70" data-thickness=".3"
                                        data-angleoffset="0" data-linecap="round" data-fgcolor="#7366ff"
                                        data-bgcolor="#eef5fb" readonly value="<?php echo e(round($totalP)); ?>"%>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="media-body right-chart-content">
                                    <h4>₹
                                        ...
                                        <span style="background: rgb(0, 0, 0);"
                                            class="new-box"><?php echo e($date); ?></span>
                                    </h4>
                        ...
                        <div class="card-body">
                            <div class="media align-items-center">
                                ...
                                <div class="knob-block text-center">
                                    ...
                                    <input class="knob1" data-width="10" data-height="70" data-thickness=".3"
                                        data-angleoffset="0" data-linecap="round" data-fgcolor="#7366ff"
                                        data-bgcolor="#eef5fb" value="<?php echo e(round($totalPR)); ?>"%>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u806064127/domains/hnmall.co.in/public_html/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>