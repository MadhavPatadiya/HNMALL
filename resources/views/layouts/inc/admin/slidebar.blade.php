<div class="sidebar-wrapper">
    <div>
        <div class="logo-wrapper">
            ...
            <div>
                <img class="center" src="{{ asset('admin/assets/images/login_logo_HN-removebg.png') }}" width="">
            </div>
            {{-- <div class="text">એચ.એન.મોલ</div> --}}
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list">
                        <a class="sidebar-link " href="{{ url('admin/dashboard') }}"><i data-feather="home"></i><span
                                class="">Dashboard
                            </span></a>
              ...
              <ul class="sidebar-submenu">
                ...
                <li><a href="user-cards.html">Users Cards</a></li>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('admin/bachat') }}">માસિક બચત ફોર્મ</a></li>
                            <li><a href="{{ url('admin/deposite') }}">ફિક્સ ડિપોઝિટ ફોર્મ</a></li>
                            <li><a href="{{ url('admin/dikari') }}">દીકરી કરિયાવર ફોર્મ</a>
                        </ul>
                    </li>
                    {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                data-feather="server"></i><span>Recipts</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('admin/one') }}">Recipt One</a></li>
                            <li><a href="{{ url('admin/two') }}">Recipt Two</a></li>
                            <li><a href="{{ url('admin/three') }}">Recipt Three</a></li>
                            <li><a href="{{ url('admin/four') }}">Recipt Four</a></li>
                            <li><a href="{{ url('admin/bachat_recipt') }}">Bachat Recipt</a></li>
                            <li><a href="{{ url('admin/dikari_recipt') }}">Dikari Recipt</a></li>
                            <li><a href="{{ url('admin/deposite_recipt') }}">Deposite Recipt</a></li>
                        </ul>
                    </li> --}}
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                        ...
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('admin/bachat/create') }}">માસિક બચત ફોર્મ</a></li>
                            <li><a href="{{ url('admin/deposite/create') }}">ફિક્સ ડિપોઝિટ ફોર્મ</a></li>
                            <li><a href="{{ url('admin/dikari/create') }}">દીકરી કરિયાવર ફોર્મ</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                            ...
                            <span>EMI</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('admin/emi') }}">EMI ફોર્મ</a></li>
                            <li><a href="{{ url('admin/emi/create') }}">EMI ફોર્મ જોવો</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i
                                class="fa-solid fa-arrow-down-up-across-line fa-beat">&nbsp;</i><span><b>
                                    આવક/જાવક</b></span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('admin/roj_med') }}">એન્ટ્રી કરો </a></li>
                            <li><a href="{{ url('admin/roj_med/view') }}">આવક/જાવક હિસાબ </a></li>
                        </ul>
                    </li>
                    ...
                    @if (Auth::user()->role_as == '1')
                        <li class="sidebar-list">
                            <a class="sidebar-link " href="{{ url('admin/real_roj_med/view_real_roj_med') }}"><i
                    ...
                    @if (Auth::user()->role_as == '1')
                        <li class="sidebar-list">
                            <a class="sidebar-link " href="{{ url('admin/user_list/create') }}"><i
                    ...
                    @if (Auth::user()->role_as == '1')
                        <li class="sidebar-list">
                            <a class="sidebar-link " href="{{ url('admin/report') }}"><i
                    ...
                    {{-- <div class="left-header">
                        <ul class="horizontal-menu d-flex">
                            <li class="nav-item level-menu outside">
                                <a class="nav-link" href="{{ url('admin/bachat-receipt/create') }}">
                                    <i data-feather="inbox"></i>
                                    <span>માસિક બચત પહોંચ</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="left-header">
                        <ul class="horizontal-menu d-flex">
                            <li class="nav-item mega-menu outside">
                                <a class="nav-link" href="{{ url('admin/bachat-receipt') }}">
                                    <i data-feather="layers"></i>
                                    <span>Bachat Receipt</span>
                                </a>
                            </li>
                        </ul>
                    </div> --}}
                    {{-- <li class="sidebar-main-title">
                        <div>
                            <h6>પહોંચ</h6>
                            <p>માસિક બચત & ફિક્સ ડિપોઝીટ </p>
                        </div>
                    </li>

                    <li class="sidebar-list mt-2"><a class="sidebar-link sidebar-title link-nav"
                            style="background-color: rgb(254,224,232);"
                            href="{{ url('admin/bachat-receipt/create') }}"><i data-feather="printer"
                                style="color: red;"> </i>
                            <span style="color: red;">માસિક બચત
                                પહોંચ</span></a></li>

                    <li class="sidebar-list mt-2"><a class="sidebar-link sidebar-title link-nav"
                            style="background-color: rgb(234,232,255);"
                            href="{{ url('admin/deposite/fix_deposite_receipt') }}"><i data-feather="printer"
                                style="color: rgb(14,129,255);">
                            </i><span style="color:
                                rgb(14,129,255);">ફિક્સ ડિપોઝીટ
                                પહોંચ</span></a></li> --}}
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                            href="admin/starter-kit/index.html" target="_blank"><i
